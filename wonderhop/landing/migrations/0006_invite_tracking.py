...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Invite'
        db.create_table('landing_invite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landing.Signup'])),
        ...
        db.send_create_signal('landing', ['Invite'])


    def backwards(self, orm):
        
        # Deleting model 'Invite'
        db.delete_table('landing_invite')
    ...
    models = {
        ...
        'landing.invite': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landing.Signup']"}),
