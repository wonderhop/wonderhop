...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Signup.backstretch_url'
        db.add_column('landing_signup', 'backstretch_url', self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Signup.backstretch_url'
        db.delete_column('landing_signup', 'backstretch_url')
    ...
    models = {
        ...
        'landing.signup': {
            ...
            'backstretch_url': ('django.db.models.fields.CharField', [], {'max_length': '384', 'null': 'True', 'blank': 'True'}),
